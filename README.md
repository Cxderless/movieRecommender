This Python script allows you to make an account which stores the information on a text file, or sign up to an existing one. All of this is done through the Python GUI with tkinter.
